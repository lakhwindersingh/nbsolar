...
To build the final jar and optimize the NBSolar application for production, run:
...
Then navigate to [http://localhost:9696](http://localhost:9696) in your browser.
