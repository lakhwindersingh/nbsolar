package com.neutronbinary.infectolabs.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.neutronbinary.infectolabs.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.neutronbinary.infectolabs.repository.UserRepository.USERS_BY_EMAIL_CACHE);
